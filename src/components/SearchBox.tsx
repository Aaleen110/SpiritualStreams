...
const SearchBox = ({ 
	placeholder = "Search Sermons, Topics, or Authors...", 
	className = "",
	onSearch 
}: SearchBoxProps) => {
		...
		<div className={`relative ${className}`}>
			<div className="relative">
				...
				<Input
					...
					className={`
						pl-10 pr-10 h-12 bg-zinc-800 border-zinc-700 text-white placeholder:text-zinc-400
				...
				{query && (
					<Button
						...
						size="sm"
						onClick={handleClear}
						className="absolute right-2 top-1/2 transform -translate-y-1/2 h-8 w-8 p-0 text-zinc-400 hover:text-white hover:bg-zinc-700"
					>
						<X className="h-4 w-4" />
					</Button>
				)}
			...
			{isFocused && query && (
				<div className="absolute top-full left-0 right-0 mt-1 bg-zinc-900 border border-zinc-700 rounded-lg shadow-lg z-50 max-h-80 overflow-y-auto">
					<div className="p-4">
						<div className="text-sm text-zinc-400 mb-3">Search results for "{query}"</div>
						...
						<div className="mb-4">
							...
							<div className="space-y-2">
								<div className="flex items-center gap-3 p-2 rounded hover:bg-zinc-800 cursor-pointer">
									<div className="w-8 h-8 bg-zinc-700 rounded flex-shrink-0"></div>
									<div className="flex-1 min-w-0">
										<div className="text-sm font-medium text-white truncate">Blinding Lights</div>
								...
								<div className="flex items-center gap-3 p-2 rounded hover:bg-zinc-800 cursor-pointer">
									<div className="w-8 h-8 bg-zinc-700 rounded flex-shrink-0"></div>
									<div className="flex-1 min-w-0">
										<div className="text-sm font-medium text-white truncate">Shape of You</div>
						...
						<div className="mb-4">
							...
							<div className="space-y-2">
								<div className="flex items-center gap-3 p-2 rounded hover:bg-zinc-800 cursor-pointer">
									...
									<div className="flex-1 min-w-0">
										<div className="text-sm font-medium text-white truncate">Harry Styles</div>
						...
						<div>
							...
							<div className="space-y-2">
								<div className="flex items-center gap-3 p-2 rounded hover:bg-zinc-800 cursor-pointer">
									<div className="w-8 h-8 bg-zinc-700 rounded flex-shrink-0"></div>
									<div className="flex-1 min-w-0">
										<div className="text-sm font-medium text-white truncate">Harry's House</div>
